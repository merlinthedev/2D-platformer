...
namespace GXPEngine {
    ...
    public class Sprite : GameObject {
        ...
        virtual public int width {
            get {
                if (_texture != null) {
                    return (int)Math.Abs(_texture.width * _scaleX);
                }
            ...
            set {
                if (_texture != null && _texture.width != 0) {
                    scaleX = value / ((float)_texture.width);
                }
            }
        }
        ...
        virtual public int height {
            get {
                if (_texture != null) {
                    return (int)Math.Abs(_texture.height * _scaleY);
                }
            ...
            set {
                if (_texture != null && _texture.height != 0) {
                    scaleY = value / ((float)_texture.height);
                }
            }
        }
