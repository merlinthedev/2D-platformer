...
namespace GXPEngine {
    ...
    public class Window {
        ...
        /// </summary>
        public float centerX => _windowX + _width / 2f;
        /// <summary>
        /// The y coordinate of the window center
        /// </summary>
        public float centerY => _windowY + _height / 2f;
        /// <summary>
        /// The window's width
        /// </summary>
        public int width {
        ...
        void SetRenderRange() {
            ...
            for (int i = 0; i < 4; i++) {
                if (worldSpaceCorners[i].x > maxX) {
                    maxX = worldSpaceCorners[i].x;
                }

                if (worldSpaceCorners[i].x < minX) {
                    minX = worldSpaceCorners[i].x;
                }

                if (worldSpaceCorners[i].y > maxY) {
                    maxY = worldSpaceCorners[i].y;
                }

                if (worldSpaceCorners[i].y < minY) {
                    minY = worldSpaceCorners[i].y;
                }
            }
