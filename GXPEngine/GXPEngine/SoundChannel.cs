...
namespace GXPEngine {
    ...
    public class SoundChannel {
        ...
        public float Frequency {
            ...
            set => _system.SetChannelFrequency(_id, value);
        }
        ...
        /// </summary>
        public float Pan {
            get => _system.GetChannelPan(_id);
            set => _system.SetChannelPan(_id, value);
        }
        ...
        public bool IsPaused {
            get => _system.GetChannelPaused(_id);
            set => _system.SetChannelPaused(_id, value);
        }
        ...
        /// </value>
        public bool IsPlaying => _system.ChannelIsPlaying(_id);
        ...
        /// </value>
        public float Volume {
            get => _system.GetChannelVolume(_id);
            set {
                _volume = value;
                if (!_isMuted) {
