...
namespace GXPEngine {
    ...
    public class AnimationSprite : Sprite {
        ...
        override public int width {
            get {
                if (_texture != null) {
                    return (int)Math.Abs(_texture.width * _scaleX * _frameWidth);
                }
            ...
            set {
                if (_texture != null && _texture.width != 0) {
                    scaleX = value / ((float)_texture.width * _frameWidth);
                }
            }
        }
        ...
        override public int height {
            get {
                if (_texture != null) {
                    return (int)Math.Abs(_texture.height * _scaleY * _frameHeight);
                }
            ...
            set {
                if (_texture != null && _texture.height != 0) {
                    scaleY = value / ((float)_texture.height * _frameHeight);
                }
            }
        }
